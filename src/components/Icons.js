...
export const TwitterIcon = ({ className, ...rest }) => (
    ...
    >
        <path
            fill="currentColor"
            d="M714.163 519.284L1160.89 0H1054.4L667.137 450.887L357.328 0H0L468.492 681.821L0 1226.37H106.49L515.939 749.375L842.672 1226.37H1200L714.137 519.284H714.163ZM570.165 686.578L523.197 619.351L149.988 85.576H312.817L614.73 515.38L661.698 582.607L1054.47 1144.89H891.64L570.165 686.604V686.578Z"
        />
    </svg>
);
// #0A66C2
...
export const InstagramIcon = ({ className, ...rest }) => {
    ...
    return (
        ...
        >
            ...
            <circle cx="17" cy="7" r="1.5" fill={`url(#${gradientId})`} />
        </svg>
    );
};
...
export const CircularText = ({
    ...
    <svg
        ...
        {...rest}
    >
        {/* This path defines the invisible circle the text will follow */}
        <path
            id="circlePath"
            d="M 100, 50 
            a 50,50 0 1,1 0,100 
